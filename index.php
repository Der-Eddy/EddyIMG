...
<head>
  ...
  <?php 
    require 'session.php';
    require 'folder.php';?>
  <a href="./index.php" id="header"><div class="ui huge header"><i class="cloud icon"></i>EddyRandom</div></a>
  Random Images
  <div class="blue ui message"><div class="ui red left corner label"><div class="text">New</div></div>Auflistung meiner Random Bilder</div>
